...
/*
   ...
   Instructions for compiling and running the project:
	...
	2. Use an ssh file transfer program (such as winscp) to transfer all files from the src
   	...
   	3. Make sure dino.l, dino.y, west.toy, func.toy, and test.toy are in the same folder.
	...
	9. Type "./a.out < west.toy" or "./a.out < func.toy" to use our test files that we created to account for possible 
